...
public final class Song {
    ...
    /**
     * สร้างเพลงหนึ่งเพลง
     * @param title ชื่อเพลงห้าม null หรือว่าง
     * @param artist artist ห้าม null หรือว่าง
     * @param tags tags ห้าม null หรือว่าง
    ...
    public Song(String title, String artist, List<String> tags) {
        ...
        if (title ==null || title==""||artist==null||artist==" Title null/empty")
            throw new IllegalArgumentException();
        if (tags ==null||tags.contains(null)||tags.contains("tags proplem"))
            throw new IllegalArgumentException();
        this.title = title;
        this.artist = artist;
